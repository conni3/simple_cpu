<#
.SYNOPSIS
    Sets up GitHub milestones and issues for your single-cycle CPU project.
.DESCRIPTION
    Requires GitHub CLI (gh) installed and authenticated (run `gh auth login` first).
    Run this script in PowerShell (ensure execution policy allows running scripts).
#>

# -- Milestones --
gh milestone create "Core Module Development" --description "Implement all individual RTL blocks in Verilog."
gh milestone create "Unit Testing & Verification" --description "Build and run a testbench for each RTL block, then a top-level CPU test."
gh milestone create "Vivado Project Setup & Integration" --description "Create a reusable Vivado flow via Tcl, import RTL & TBs, and verify end-to-end simulation."
gh milestone create "Memory Initialization & Program Loading" --description "Generate a program image, integrate it into your instruction ROM, and verify fetches."
gh milestone create "Synthesis, Bitstream & FPGA Testing" --description "Synthesize, implement, generate bitstream, and validate on actual FPGA hardware."

# -- Milestone 1: Core Module Development Issues --
...
# -- Milestone 2: Unit Testing & Verification Issues --
...
# -- Milestone 3: Vivado Project Setup & Integration Issues --
...
# -- Milestone 4: Memory Initialization & Program Loading Issues --
...
# -- Milestone 5: Synthesis, Bitstream & FPGA Testing Issues --
gh issue create --title "Run Synthesis & Implementation" `
  --body "Use Tcl or GUI to synthesize and implement the design." `
  --milestone "Synthesis, Bitstream & FPGA Testing"

gh issue create --title "Generate Bitstream" `
  --body "Produce .bit file for your target FPGA part." `
  --milestone "Synthesis, Bitstream & FPGA Testing"

gh issue create --title "Load Bitstream onto FPGA Board" `
  --body "Flash the generated bitstream to your development board." `
  --milestone "Synthesis, Bitstream & FPGA Testing"

gh issue create --title "Hardware Smoke-Test" `
  --body "Basic LED blink or register write/read to confirm FPGA logic." `
  --milestone "Synthesis, Bitstream & FPGA Testing"

gh issue create --title "Functional Verification on Silicon" `
  --body "Run your sample program on the actual CPU and verify outputs." `
  --milestone "Synthesis, Bitstream & FPGA Testing"
