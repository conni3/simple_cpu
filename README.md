...
| **alu_control** | `alu_op`, `funct3`, `funct7_5` | `alu_ctrl` |
| **branch_comp** | `op1`, `op2`, `funct3` | `branch_taken` |
...
| **controller** | `instr` | `opcode`, `rd`, `funct3`, `rs1`, `rs2`, `funct7`, `csr`, `alu_ctrl`, `imm_out`, `reg_write`, `mem_read`, `mem_write`, `alu_src`, `op1_sel`, `wb_sel`, `is_branch`, `is_jal`, `is_jalr` |
| **cpu** | `clk`, `reset` | – |
| **data_mem** | `clk`, `mem_write`, `mem_read`, `addr`, `wdata` | `rdata` |
| **datapath** | `clk`, `reset`, `opcode`, `rd`, `funct3`, `rs1`, `rs2`, `funct7`, `csr`, `alu_ctrl`, `imm_out`, `reg_write`, `mem_read`, `mem_write`, `alu_src`, `op1_sel`, `wb_sel`, `is_branch`, `is_jal`, `is_jalr` | `instr` |
| **decoder** | `instr` | `is_alu_reg`, `reg_write`, `is_jal`, `is_jalr`, `is_branch`, `is_lui`, `is_auipc`, `is_alu_imm`, `is_load`, `is_store`, `is_system` |
| **decoder_glue** | `instr` | `rd`, `rs1`, `rs2`, `imm_out`, `reg_write`, `mem_read`, `mem_write`, `alu_src`, `branch_sig`, `jump`, `alu_op`, `imm_sel`, `wb_sel`, `is_jal`, `is_jalr`, `is_branch`, `is_lui`, `is_auipc`, `is_alu_reg`, `is_alu_imm`, `is_load`, `is_store`, `is_system` |
| **imm_gen** | `instr`, `imm_sel` | `imm_out` |
| **instr_mem** | `addr` | `instr` |
| **instr_slicer** | `instr` | `opcode`, `rd`, `funct3`, `rs1`, `rs2`, `funct7`, `shamt`, `csr` |
| **mux2** | `a`, `b`, `sel` | `y` |
| **mux4** | `a`, `b`, `c`, `d`, `sel` | `y` |
| **next_pc** | `pc_current`, `imm_out`, `rs1_data`, `is_branch`, `is_jal`, `is_jalr`, `branch_taken` | `pc_next` |
| **pc** | `clk`, `reset`, `next_pc` | `current_pc` |
| **regfile** | `clk`, `reset`, `reg_write`, `rs1`, `rs2`, `rd`, `rd_wdata` | `rs1_data`, `rs2_data` |
| **wb_mux** | `alu_result`, `rdata`, `pc_plus4`, `wb_sel`, `reg_write_in`, `kill_wb`, `rd_in` | `rd_wdata`, `reg_write_out`, `rd_out` |
